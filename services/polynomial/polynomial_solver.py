...
FIXED: Now supports LaTeX fractions \\frac{a}{b} in coefficient input
"""
import math
import numpy as np
...
class PolynomialSolver:
    ...
    def parse_expression(self, expr: str) -> float:
        ...
        # FIXED: Handle LaTeX fractions \\frac{a}{b} -> (a)/(b)
...
if __name__ == "__main__":
    ...
    # NEW TEST: LaTeX fraction \\frac{9}{4}
    print("\n=== TEST LATEX FRACTION ===")
    success, msg, roots, display = solver.solve_polynomial(["\\frac{9}{4}", "1", "2"], 2)
    print(f"Success: {success}")
    print(f"Message: {msg}")
    print(f"Display:\n{display}")