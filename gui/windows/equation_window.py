...
class EquationWindow:
    ...
    def _setup_ui(self):
        ...
        self.btn_import = tk.Button(
            ...
            width=14,
            height=1,
            command=lambda: messagebox.showinfo("Import", "Import Excel sẽ được implement")
        )
        ...
        self.btn_process = tk.Button(
            ...
            width=16,
            height=1,
            command=lambda: messagebox.showinfo("Xử lý", "Giải nghiệm sẽ được implement")
        )
        ...
        self.btn_import_other = tk.Button(
            ...
            width=14,
            height=1,
            command=lambda: messagebox.showinfo("Import Khác", "Import file khác sẽ được implement")
        )
    ...
    def _on_phien_ban_changed(self, event=None):
        ...
        # self.controller.set_phien_ban(self.phien_ban_var.get())  # Removed
