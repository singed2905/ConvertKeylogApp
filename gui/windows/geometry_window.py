...
class GeometryWindow:
    def __init__(self, window):
        self.window = window
        # self.controller = GeometryController()  # Removed
        # self.actions = GeometryActions(self, self.controller)  # Removed
    ...
    def _update_system_info(self):
        ...
        try:
            # Removed psutil dependency - just UI
...
📖 Chi tiết: Xem documentation đầy đủ
    ...
    def _setup_group_b_frames(self):
        ...
        # Output boxes
        tk.Label(self.frame_B_mat, text="Output - Kết quả mã hóa:", bg="#FFFFFF").grid(row=2, column=0, columnspan=8, pady=5)
    ...
    def _setup_control_frame(self):
        ...
        self.btn_import_excel = tk.Button(
            ...
            command=lambda: messagebox.showinfo("Import", "Chức năng import sẽ được implement"),
        ...
        tk.Button(self.frame_buttons_import, text="🚀 Xử lý File Excel",
                  command=lambda: messagebox.showinfo("Import Excel", "Xử lý import Excel sẽ được implement"),
        ...
        tk.Button(self.frame_buttons_import, text="↩️ Quay lại",
                  command=lambda: messagebox.showinfo("Quay lại", "Quay lại chế độ manual"),
    ...
    def _on_version_changed(self, *args):
        ...
        # self.controller.set_current_version(selected_version)  # Removed
        self._update_quick_stats()
    ...
    def _update_dropdown_options(self, *args):
        ...
        pheptoan = self.pheptoan_var.get()
        allowed_shapes = ["Điểm", "Đường thẳng", "Mặt phẳng", "Đường tròn", "Mặt cầu"]
    ...
    def _reset_interface(self):
        ...
        # self.actions._unlock_all_input_entries()  # Removed
